...
public class BigModelChart extends WebSocketListener {
    ...
    public static final String appid = "64eaf784";
    public static final String apiSecret = "NGVlM2QxMDQ2NTU1Zjk4YjkzYjVlYjky";
    public static final String apiKey = "0168e46036c2f2813029a23c5e5b9b13";
    ...
    // 构造函数
    public BigModelChart(String userId, Boolean wsCloseFlag) {
        this.userId = userId;
        this.wsCloseFlag = wsCloseFlag;
    }

    public BigModelChart(long questionId, RedissonClient redissonClient) {
    ...
    public void getResult(String newQuestion) {
        try {
            ...
            for (int i = 0; i < 1; i++) {
                totalAnswer = "";
                WebSocket webSocket = client.newWebSocket(request, new BigModelChart(i + "",
                        false));
            }
